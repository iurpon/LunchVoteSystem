...
public class DishTestData {
    ...
    public static final Dish DISH1 = new Dish(DISH_SEQ1,"Big Burger",5.2,MENU2);
    public static final Dish DISH2 = new Dish(DISH_SEQ2,"Kola",2.0,MENU2);
    public static final Dish DISH3 = new Dish(DISH_SEQ3,"Steak",10,MENU1);
    public static final Dish DISH4 = new Dish(DISH_SEQ4,"Milk Cocktail",1.5,MENU1);
    public static final Dish DISH5 = new Dish(DISH_SEQ5,"Pancake",2,MENU1);
}
